...
import MemoryEasy from './MemoryCardGame/MemoryEasy';
import MemoryMedium from './MemoryCardGame/MemoryMedium';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/easy" element={<ProtectedRoute element={MemoryEasy} />} />
        <Route path="/medium" element={<ProtectedRoute element={MemoryMedium} />} />
